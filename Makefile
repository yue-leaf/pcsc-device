...
$(MICROSERVICES):
	GOOS=linux GOARCH=amd64 CGO_ENABLED=1  go build $(GOFLAGS) -a -tags netgo -ldflags '-extldflags "-Wl,--verbose -L/usr/lib -L/usr/local/lib -lpcsclite -static"' -o ./cmd/$(MICROSERVICES).bin  ./cmd
